package com.juaracoding.stellamakahaube;
...
public class PostTestStellaMakahaube {
    public static void main(String[] args) {
        ...
        delay(detik);
        driver.findElement(By.id("first-name")).sendKeys("Stella");
        System.out.println("input first name");
        delay(detik);
        driver.findElement(By.id("last-name")).sendKeys("Makahaube");
